...
function endgameSynopsis(){
    ...
    document.getElementById("endgameTrailer").src = "https://www.youtube.com/embed/TcMBFSGVi1c";
    document.getElementById("endgameTrailer").style.border = "1px solid white";
}

function topEndWeddingSynopsis(){
    ...
    document.getElementById("endgameTrailer").src = "https://www.youtube.com/embed/uoDBvGF9pPU";
    document.getElementById("endgameTrailer").style.border = "1px solid white";
}

function dumboSynopsis(){
    ...
    document.getElementById("endgameTrailer").src = "https://www.youtube.com/embed/7NiYVoqBt-8";
    document.getElementById("endgameTrailer").style.border = "1px solid white";
}

function theHappyPrinceSynopsis(){
    ...
    document.getElementById("endgameTrailer").src = "https://www.youtube.com/embed/4HmN9r1Fcr8";
    document.getElementById("endgameTrailer").style.border = "1px solid white";
}
